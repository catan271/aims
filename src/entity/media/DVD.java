...
public class DVD extends Media {
    ...
    public DVD(int id, String title, String category, int price, int quantity, String imageURL, String type,
               String discType, String director, int runtime, String studio, String subtitles, Date releasedDate, String filmType) throws SQLException {
    ...
    public Media getMediaById(int id) throws SQLException {
        ...
        if (res.next()) {
            ...
            return new DVD(id, title, category, price, quantity, imageURL, type,
